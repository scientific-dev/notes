...
\section{Population Distribution of Atoms}

To understand the lasing process in a simplistic manner, we are going to distribute atoms of the system (for any state) into their respective energy levels in a graph. Let there be $N_{p}$ atoms excited at the energy level $E_{p}$ where $p$ is some integer.
