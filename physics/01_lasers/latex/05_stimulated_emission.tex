...
\draw[->, snake it, atom_red] (3.5,1.6) -- (5.5,1.6);
\draw[->, snake it, atom_red] (3.5,0.8) -- (5.5,0.8);
...
\node at (4.5, 2) {\textbf{\large Incident Photon}};
\node at (4.5, 1.2) {\textbf{\large Emitted Photon}};
\node at (4.5, 0.4) {\textbf{\LARGE $\nu$}};
